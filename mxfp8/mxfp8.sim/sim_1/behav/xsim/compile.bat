...
REM
REM Generated by Vivado on Wed Feb 18 17:37:48 +0100 2026
...
echo "xvlog --incr --relax -L uvm -prj mxfp8_dotp_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj mxfp8_dotp_tb_vlog.prj -log xvlog.log
