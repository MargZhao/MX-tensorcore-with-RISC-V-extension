...
REM
REM Generated by Vivado on Fri Oct 31 11:52:48 +0100 2025
...
echo "xvlog --incr --relax -L uvm -prj fp8_fma_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj fp8_fma_tb_vlog.prj -log xvlog.log
