...
REM
REM Generated by Vivado on Tue Feb 24 03:24:01 +0100 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_onedotproduct_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_onedotproduct_vlog.prj -log xvlog.log
